...
const AllOrder = () => {
  ...
  const { Filter_Order, handleSearch, getAllOrder } = useOrder();
      ...
      <div className='row order_Show mx-0'>
        <div className='col-12 order_entries'>
          <form>
            ...
            <div className='Form_Right'>
              <label>Search:</label>
              <input type='text' name="AllOrder_Search" onChange={handleSearch} />
            </div>
          </form>
        ...
        <div className='col-12 order_entries_show'>
          <table className="table table-bordered table-striped">
            ...
            <tbody className="table-group-divider">
              {Filter_Order.slice(currentPage * perPage, (currentPage + 1) * perPage).map((product, index) => {
                return (
                  <tr key={product._id}>
                    ...
                    <td className='table_btn align-middle'>
                      <NavLink to={`/admin/allOrders/orderInvoice/${product._id}`} className="btn btn-primary btn-sm button">
                        <GrView />
                      </NavLink>
        ...
        <div className='col-12'>
          <ReactPaginate
            ...
            nextLabel="Next"
            breakLabel="..."
            pageCount={Math.ceil(Filter_Order.length / perPage)}
